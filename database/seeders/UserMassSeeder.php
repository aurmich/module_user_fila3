...
class UserMassSeeder extends Seeder
{
    ...
    private function createUsersWithProfiles(): void
    {
        ...
        foreach ($users as $user) {
            ...
            $user->assignRole($randomRole); /** @phpstan-ignore method.nonObject */
        }

        $this->command->info('✅ Creati '.$users->count()/** @phpstan-ignore method.nonObject */.' utenti con profili completi');
    }
    ...
    private function createAuthenticationLogs(): void
    {
        ...
        $this->command->info('✅ Creati '.$logs->count()/** @phpstan-ignore method.nonObject */.' log di autenticazione');
    }
    ...
    private function createUserDevices(): void
    {
        ...
        $this->command->info('✅ Creati '.$devices->count()/** @phpstan-ignore method.nonObject */.' dispositivi utente');
    }
    ...
    private function createSocialProviders(): void
    {
        ...
        $this->command->info('✅ Creati '.$providers->count()/** @phpstan-ignore method.nonObject */.' provider social');
    }

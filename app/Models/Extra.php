 ...
 * @method static Extra|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Extra> get()
 * @method static Extra create(array $attributes = [])
 * @method static Extra firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Extra where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Extra whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)

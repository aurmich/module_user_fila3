 ...
 *
 * @method static BaseTeamUser|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, BaseTeamUser> get()
 * @method static BaseTeamUser create(array $attributes = [])
 * @method static BaseTeamUser firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BaseTeamUser where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BaseTeamUser whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)

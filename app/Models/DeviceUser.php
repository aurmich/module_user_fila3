 ...
 *
 * @method static DeviceUser create(array $attributes = [])
 * @method static DeviceUser firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|DeviceUser where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')

 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Permission where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')

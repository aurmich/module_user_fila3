 ...
 * @method static BaseUser|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, BaseUser> get()
 * @method static BaseUser create(array $attributes = [])
 * @method static BaseUser firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BaseUser where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|BaseUser whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
...
abstract class BaseUser extends Authenticatable implements HasMedia, HasName, HasTenants, UserContract
{
    ...
    {
        return $this->hasRole('super-admin'); /** @phpstan-ignore method.nonObject */
    }
    ...
    public function assignModule(string $module): void
    {
        ...
        $this->assignRole($role); /** @phpstan-ignore method.nonObject */
    }
    ...
    public function canAccessPanel(Panel $panel): bool
    {
        ...
        if ($panel->getId() !== 'admin') {
            ...
            */
            ...
            return $this->hasRole($role); /** @phpstan-ignore method.nonObject */
        }
    ...
    public function hasRole($roles, ?string $guard = null): bool
    {
        ...
        if (is_array($roles) || $roles instanceof \Illuminate\Support\Collection) {
            foreach ($roles as $role) {
                if ($this->hasRole($role, $guard)/** @phpstan-ignore method.nonObject */) {
                    return true;
                }
            }

 ...
 * @method static SocialProvider create(array $attributes = [])
 * @method static SocialProvider firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SocialProvider where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')

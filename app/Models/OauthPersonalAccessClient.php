 ...
 * @method static OauthPersonalAccessClient create(array $attributes = [])
 * @method static OauthPersonalAccessClient firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|OauthPersonalAccessClient where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')

 ...
 * @method static Feature|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Feature> get()
 * @method static Feature create(array $attributes = [])
 * @method static Feature firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Feature where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Feature whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)

...
L'implementazione attuale del file `/var/www/html/<directory progetto>/laravel/Themes/One/resources/views/pages/auth/logout.blade.php` presenta i seguenti problemi:
